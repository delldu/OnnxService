...
#define DEFINE_SERVICE_CODE(major, minor)                                      \
  ((((major)&0xff) << 24) | ((minor)&0xff) << 16)
#define SERVICE_CODE(msgcode) ((msgcode)&0xffff0000)
#define SERVICE_ARGUMENT(msgcode) ((msgcode)&0xffff)
#define DEFINE_SERVICE(service_code, service_arg)                              \
  (((service_code)&0xffff0000) | ((service_arg)&0xffff))

/****************************************************************************************
***
***  DO NOT USE major service code 0xF for it define in NImage project for
*system service ...
...
#define IMAGE_ZOOM_SERVICE_WITH_ANY_SIZE DEFINE_SERVICE_CODE(5, 3)
